...
describe('RolloutClient', function() {
    describe('init() with projectId & token', function() {
      it('should return a new RolloutClient', function() {
        ...
        it('should return the auth token', function(done) {
            ...
            //   assert(tdclient != null);
              ...
              var signOptions = {                                                            
                ...
                audience:  'https://rollout.com/projects/' + PROJECT_ID
              };
            ...
            if (tdclient) {
              assert(tdclient != null);
                ...
                tdclient.sendSupportMessage(request_id, {text: text_value}, function(err, result) {
                    ...
                    const tdclient_user = new RolloutClient(
                        {
                            APIKEY: APIKEY,
                            APIURL: API_ENDPOINT,
                            projectId: PROJECT_ID,
