...
/**
 * This class is a NodeJS stub for Rollout's REST APIs
 */
class RolloutClient {

  static DEFAULT_API_ENDPOINT = "https://api.rollout.com/v2";
  static ASSIGNED_STATUS = 200;
  static UNASSIGNED_STATUS = 100;

  /**
   * Constructor for RolloutClient object
   *
   * @example
   * const { RolloutClient } = require('Rollout-client');
   * const tdclient = new RolloutClient({APIKEY: 'THE_API_KEY', projectId: 'YOUR_PROJECT_ID', token: 'YOUR_AUTH_TOKEN'});
   * const tdclient = new RolloutClient({APIKEY: 'THE_API_KEY', projectId: 'YOUR_PROJECT_ID', token: 'YOUR_AUTH_TOKEN', APIURL: 'SELF_HOSTED_INSTANCE_ENDPOINT'});
   * 
   * @param {Object} options JSON configuration.
   * @param {string} options.APIKEY Mandatory. Rollout APIKEY
   * @param {string} options.projectId Mandatory. Rollout projectId. Will be used in each call on project's APIs.
   * @param {string} options.token Mandatory. Rollout authentication token. Will be used in each call on project's APIs.
   * @param {string} options.APIURL Optional. Rollout server API endpoint.
  ...
  constructor(options) {
    ...
    if (options && options.APIURL) {
      ...
      this.APIURL = RolloutClient.DEFAULT_API_ENDPOINT;
    }
    ...
    if (!options.token) {
      ...
      this.jwt_token = RolloutClient.fixToken(options.token)
    }
  ...
  */
  ...
  createProject(projectId, callback) {
    // const jwt_token = RolloutClient.fixToken(token)
    ...
    RolloutClient.myrequest(
      ...
      function(err, resbody) {
        ...
        // }
        // else if (callback) {
        //   callback(RolloutClient.getErr(err, HTTPREQUEST, response, resbody), null);
        // }
      }, this. log);
  }
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/projects#get-the-project-detail' target='_blank'>REST API</a>
   * 
  ...
  getProjectSettings(callback) {
    // const jwt_token = RolloutClient.fixToken(this.token)
  ...
  /**
   * Returns all teammates (aka Project Users, Rollout Users invited on a specific project are named "Teammates". They have additional properties and a specific project-userId)<br>
   * <a href='https://developer.rollout.com/apis/rest-api/team#get-the-team' target='_blank'>REST API</a>
   * @param {resultCallback} callback - The callback that handles the response.
   */
   getTeam(callback) {
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/team#update-the-current-logged-teammate' target='_blank'>REST API</a>
   * 
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/requests#set-the-request-participants' target='_blank'>REST API</a>
   * @param {string} requestId - The request ID.
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/requests#delete-a-participant-from-the-request' target='_blank'>REST API</a>
   * @param {string} requestId - The request ID.
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/requests#add-a-participant-to-a-request' target='_blank'>REST API</a>
   * @param {string} requestId - The request ID.
   * @param {array} participantId - the participant (agent or bot) identifier
   * @param {resultCallback} callback - The callback that handles the response.
   */
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/requests#update-a-request-by-request_id' target='_blank'>More info</a>.
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/requests#update-a-request-by-request_id' target='_blank'>REST API</a>
   * 
   * @param {string} requestId - The request ID
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/requests#update-the-request-attributes' target='_blank'>REST API</a>
   * 
   * @param {string} requestId - The request ID
 ...
 */
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/requests#route-a-request-to-a-department' target='_blank'>REST API</a>
   * 
   * @param {string} requestId - The request ID
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/chat-bots/bots#get-all-bots' target='_blank'>REST API</a>
   * @param {resultCallback} callback - The callback that handles the response.
   */
  getAllBots(callback) {
  ...
  /**
   * Get bot by id.<br>
   * <a href='https://developer.rollout.com/apis/rest-api/chat-bots/bots#get-a-bot-by-id' target='_blank'>REST API</a>
   * @param {string} botId - The bot ID.
   * @param {resultCallback} callback - The callback that handles the response.
   */
  ...
  /**
   * Create a bot.<br>
   * <a href='https://developer.rollout.com/apis/rest-api/chat-bots/bots#create-a-new-bot' target='_blank'>REST API</a>
  ...
  /**
   * Update a bot.<br>
   * <a href='https://developer.rollout.com/apis/rest-api/chat-bots/bots#update-a-bot' target='_blank'>REST API</a>
   * @param {string} botName - The bot's name.
   * @param {boolean} isExternal - 'true' if you want an external bot.
   * @param {string} botUrl - The external bot's endpoint url.
   * @param {resultCallback} callback - The callback that handles the response.
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/chat-bots/bots#delete-a-bot' target='_blank'>REST API</a>
   * @param {string} botId - The bot ID.
   * @param {resultCallback} callback - The callback that handles the response.
   */
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/management-api/departments#create-a-new-department' target='_blank'>REST API</a>
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/management-api/departments#update-a-department' target='_blank'>REST API</a>
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/management-api/departments#get-a-department-by-id' target='_blank'>REST API</a>
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/management-api/departments#get-all-active-departments' target='_blank'>REST API</a>
   * @param {resultCallback} callback - The callback that handles the response.
   */
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/management-api/departments#get-all-departments-active-or-hidden' target='_blank'>REST API</a>
   * @param {resultCallback} callback - The callback that handles the response.
   */
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/management-api/departments#delete-a-department' target='_blank'>REST API</a>
   * @param {string} depId - The department ID.
   * @param {resultCallback} callback - The callback that handles the response.
   */
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/projects#return-if-the-project-is-open-regarding-operating-hours' target='_blank'>REST API</a>
   */
  openNow(callback) {
    // const jwt_token = RolloutClient.fixToken(this.token)
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/authentication#anonymous-authentication-for-a-user.' target='_blank'>REST API</a>
   * @param {string} projectId - The projectId for this anonymous user.
   * @param {string} apikey - Your API key.
   * @param {Object} options - API call options.
   * @param {string} options.APIURL - Optional APIURL for connecting to a Rollout self-hosted instance.
  ...
  static anonymousAuthentication(projectId, apikey, options, callback) {
    ...
    let _APIURL = RolloutClient.DEFAULT_API_ENDPOINT;
    if (options && options.APIURL) {
  ...
  /** Returns a Rollout token based on a custom token.<br>
   * See <a href='https://developer.rollout.com/apis/authentication'>JWT authentication</a> for more info.<br>
   * <a href='https://developer.rollout.com/apis/rest-api/authentication#authentication-with-email-and-password' target='_blank'>REST API</a>
  ...
  /** Returns a Rollout token to connect to Rollout services.
   * <a href='REST API' target='_blank'>https://developer.rollout.com/apis/rest-api/authentication#authentication-with-email-and-password</a>
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/messages#send-a-message.' target='_blank'>REST API</a>
   * 
   * @param {string} requestId - The request ID.
  ...
  /**
   * The Chat21 message format. More on <a href='https://developer.rollout.com/widget/advanced/widget-json-protocol' target='_blank'>messages format (Review this link)</a>.
   * @typedef chatMessage
   * @type {Object}
   ...
   * You can find the standard Rollout events here<br>
   * <a href='https://developer.rollout.com/apis/rest-api/events#fire-a-new-custom-event-and-save-it' target='_blank'>REST API</a>
   ...
   * <a href='https://developer.rollout.com/apis/rest-api/leads#update-a-lead-by-id' target='_blank'>REST API</a>
   * 
