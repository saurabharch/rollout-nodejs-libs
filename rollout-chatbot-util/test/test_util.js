 ...
 describe('RolloutChatbotUtil', function() {
    describe('is_agent_handoff_command()', function() {
        it('should return agent_handoff null', function() {
            ...
            const info = RolloutChatbotUtil.is_agent_handoff_command(msg);
 ...
 describe('RolloutChatbotUtil', function() {
    describe('is_agent_handoff_command()', function() {
        it('should return agent_handoff != null', function() {
            ...
            assert.strictEqual(info.agent_handoff, RolloutChatbotUtil.AGENT_DIRECTIVE);
        });
    });
});
...
describe('RolloutChatbotUtil', function() {
    describe('This messae only contains the command', function() {
        it('should return agent_handoff != null', function() {
            ...
            const command = RolloutChatbotUtil.is_agent_handoff_command(msg);
            console.log("info:", JSON.stringify(command));
            assert.strictEqual(command.text, '');
            assert.strictEqual(command.agent_handoff, RolloutChatbotUtil.AGENT_DIRECTIVE);
        });
    });
});
