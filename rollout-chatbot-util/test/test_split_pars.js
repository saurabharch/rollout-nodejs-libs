...
describe('RolloutChatbotUtil', function() {
    describe('splitPars() 1', function() {
        it('should return multiple commands', function() {
            ...
            var commands = RolloutChatbotUtil.splitPars(text.trim());
            ...
            assert.strictEqual(commands[1].time, RolloutChatbotUtil.WAIT_TIME);
            ...
            assert.strictEqual(commands[3].time, RolloutChatbotUtil.WAIT_TIME);
