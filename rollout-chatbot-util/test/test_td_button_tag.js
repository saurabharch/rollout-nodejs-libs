...
describe('RolloutChatbotUtil', function() {
    describe('parseReply() of Quick Reply Button', function() {
        it('should return an intro text with a couple of buttons', function() {
            ...
            assert.strictEqual(reply.message.type, RolloutChatbotUtil.TYPE_TEXT);
            ...
            assert.strictEqual(reply.message.attributes.attachment.buttons[0].type, RolloutChatbotUtil.TYPE_BUTTON_TEXT);
            assert.strictEqual(reply.message.attributes.attachment.buttons[0].value, 'Button 1');
            assert.strictEqual(reply.message.attributes.attachment.buttons[1].type, RolloutChatbotUtil.TYPE_BUTTON_TEXT);
...
describe('RolloutChatbotUtil', function() {
    describe('parseReply() of Quick Reply ', function() {
        it('should return an intro text with four buttons with mixed spaces between the * and the button text', function() {
            ...
            assert.strictEqual(reply.message.attributes.attachment.buttons[1].type, RolloutChatbotUtil.TYPE_BUTTON_TEXT);
            assert.strictEqual(reply.message.attributes.attachment.buttons[1].value, 'Button 2');
            assert.strictEqual(reply.message.attributes.attachment.buttons[2].type, RolloutChatbotUtil.TYPE_BUTTON_TEXT);
            assert.strictEqual(reply.message.attributes.attachment.buttons[2].value, 'Button 3');
            assert.strictEqual(reply.message.attributes.attachment.buttons[3].type, RolloutChatbotUtil.TYPE_BUTTON_TEXT);
...
describe('RolloutChatbotUtil', function() {
    describe('parseReply() of URL Buttons', function() {
        it('should return a link.BLANK button (tdLink default to BLANK)', function() {
            ...
            assert.strictEqual(reply.message.attributes.attachment.buttons[0].type, RolloutChatbotUtil.TYPE_BUTTON_URL);
            ...
            assert.strictEqual(reply.message.attributes.attachment.buttons[0].target, RolloutChatbotUtil.TARGET_BUTTON_LINK_BLANK);
            // MESSAGE:
            // {
            //     "message": {
            //         "text": "Intro text",
...
describe('RolloutChatbotUtil', function() {
    describe('parseReply() of URL Buttons (parent)', function() {
        it('should return a link.PARENT button', function() {
            ...
            assert.strictEqual(reply.message.attributes.attachment.buttons[0].target, RolloutChatbotUtil.TARGET_BUTTON_LINK_PARENT);
            // MESSAGE:
            // {
            //     "message": {
            //         "text": "Intro text",
...
describe('RolloutChatbotUtil', function() {
    describe('parseReply() of URL Buttons (self)', function() {
        it('should return a link.SELF button', function() {
            ...
            assert.strictEqual(reply.message.attributes.attachment.buttons[0].target, RolloutChatbotUtil.TARGET_BUTTON_LINK_SELF);
            // MESSAGE:
            // {
            //     "message": {
            //         "text": "Intro text",
...
describe('RolloutChatbotUtil', function() {
    describe('parseReply() of Action Buttons', function() {
        it('should return a Action button with show_echo = false', function() {
            ...
            assert(reply.message.attributes.attachment.buttons != null);
            assert(reply.message.attributes.attachment.buttons.length == 1);
            assert.strictEqual(reply.message.attributes.attachment.buttons[0].type, RolloutChatbotUtil.TYPE_BUTTON_ACTION);
